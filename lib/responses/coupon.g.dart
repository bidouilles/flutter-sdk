...
Coupon _$CouponFromJson(Map<String, dynamic> json) => Coupon(
      ...
      displayStartsAt: json['display_starts_at'] == null
          ? null
          : DateTime.parse(json['display_starts_at'] as String),
      displayEndsAt: json['display_ends_at'] == null
          ? null
          : DateTime.parse(json['display_ends_at'] as String),
